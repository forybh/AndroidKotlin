...
import com.example.myappsqlite.databinding.ActivityMainBinding
    ...
    private fun init() {
        ...
        binding.apply {
            ...
            insertbtn.setOnClickListener {
                ...
                if(result){
                    getAllRecord()
                    Toast.makeText(this@MainActivity, "Data INSERT SUCCESS",Toast.LENGTH_LONG).show()
                }else{
                    Toast.makeText(this@MainActivity, "Data INSERT FAILED",Toast.LENGTH_LONG).show()
                }
                clearEditText()
            ...
            findbtn.setOnClickListener {
                ...
                if(result){
                    Toast.makeText(this@MainActivity, "RECORD FOUND",Toast.LENGTH_LONG).show()
                }else{
            ...
            deletebtn.setOnClickListener {
                ...
                if(result){
                    Toast.makeText(this@MainActivity, "Data DELETE SUCCESS",Toast.LENGTH_LONG).show()
                }else{
                    Toast.makeText(this@MainActivity, "Data DELETE FAILED",Toast.LENGTH_LONG).show()
                }
                getAllRecord()
                clearEditText()
            }
            updatebtn.setOnClickListener {
                ...
                if(result){
                    getAllRecord()
                    Toast.makeText(this@MainActivity, "Data UPDATE SUCCESS",Toast.LENGTH_LONG).show()
                }else{
                    Toast.makeText(this@MainActivity, "Data UPDATE FAILED",Toast.LENGTH_LONG).show()
                }
                clearEditText()
            }
        }
