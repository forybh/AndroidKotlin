package com.example.myapp11intenttest
...
import com.example.myapp11intenttest.databinding.ActivityMainBinding
        ...
        when(requestCode) {
            CALL_REQUEST->{
                if(grantResults[0]==PackageManager.PERMISSION_GRANTED){
                    ...
                    Toast.makeText(this,"권한 승인이 거부되었습니다.",Toast.LENGTH_LONG).show()
                }
            }
        }
    }
